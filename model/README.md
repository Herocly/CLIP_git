...
## 1、BERT模型转换方法(vocab.txt)

加入有2句话，分别为text01与text02(如下)，他们会转换vocab.txt中已有的单词形式。其中需要留意：``’##符号连接长单词在vocab.txt部件方式，如embeddings='em','##bed','##ding','s'。同时，没有单词``
...
=======
# CLIP-strawberry
>>>>>>> b3a3391dd93ffcf45a6c41ccba9453edd1831202
